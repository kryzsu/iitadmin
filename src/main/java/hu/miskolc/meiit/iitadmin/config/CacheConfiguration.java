...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, hu.miskolc.meiit.iitadmin.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, hu.miskolc.meiit.iitadmin.repository.UserRepository.USERS_BY_EMAIL_CACHE);
