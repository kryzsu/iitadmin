...
/**
 * REST controller for managing {@link hu.miskolc.meiit.iitadmin.domain.Artifact}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ArtifactResource {
    ...
    public ResponseEntity<Artifact> updateArtifact(@Valid @RequestBody Artifact artifact) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, artifact.getId().toString()))
            .body(result);
    }
